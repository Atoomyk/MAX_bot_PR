...
class MisHealthGuard:
    ...
    USER_UNAVAILABLE_TEXT = (
        "⛔ Запись к врачу временно недоступна — проводятся технические работы."
        "Попробуйте позже, или обратитесь в вашу медорганизацию."
    )
    ADMIN_DOWN_TEXT = "📢 Сервис МИС не доступен!"
    ADMIN_UP_TEXT = "✅️ Сервис МИС снова доступен!"
